...
export interface VehicleDataMongo {
  _id?: ObjectId;
  ...
  vin?: string;
  paymentProof?: string;
  telegramUserId?: string; // Added for Telegram bot integration
  ownerTelegramId?: string; // Added for Telegram bot integration
...
export class VehicleService {
  ...
  private convertToMongo(
    ...
    return {
      ...
      telegramUserId: vehicleData.telegramUserId, // Include in conversion
      ownerTelegramId: vehicleData.ownerTelegramId, // Include in conversion
  ...
  private convertFromMongo(mongoData: VehicleDataMongo): VehicleData {
    return {
      ...
      telegramUserId: mongoData.telegramUserId,
      ownerTelegramId: mongoData.ownerTelegramId,
      vin: mongoData.vin,
