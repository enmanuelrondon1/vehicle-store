    ...
    <>
        ...
        <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
          ...
          <SheetContent side="left" className="w-[300px] p-6 flex flex-col">
            ...
            <div className="mb-8">
              ...
              <p id="menu-description" className="text-sm mt-2 text-muted-foreground">
                  ...
                  >
                    <Link
                      ...
                      className={cn(
                        ...
                        item.requiresAdmin && "text-destructive hover:text-destructive-foreground focus:text-destructive-foreground"
                      )}
            ...
            <div className="mt-auto space-y-4 pt-6 border-t">
              {status === "authenticated" && userInfo ? (
                <div className="flex flex-col space-y-2">
                  ...
                  <DropdownMenuSeparator />
                  <Link href={siteConfig.paths.profile} onClick={handleCloseMenu} className={cn(buttonVariants({ variant: 'ghost' }), 'justify-start gap-2')}>
                  ...
                  <DropdownMenuSeparator />
                  <Button variant="outline" className="w-full justify-start gap-2" onClick={() => { handleSignOut(); handleCloseMenu(); }}>
                ...
                <Button variant="default" className="w-full" asChild>
                  <Link href={siteConfig.paths.login} onClick={handleCloseMenu} className="flex items-center justify-center gap-2">
      ...
      <nav className="hidden sm:flex items-center" role="navigation" aria-label="Navegación principal">
        <ul className="flex space-x-2 items-center">
          ...
          {navItems.map((item, index) => (
            <motion.li key={`${item.label}-${index}`} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href={item.href || "#"}
                className={cn(
                  buttonVariants({ variant: "ghost" }),
                  ...
                  >
                    ...
                    <DropdownMenuGroup>
                      <DropdownMenuItem asChild>
                        <Link href={siteConfig.paths.profile} className="flex items-center w-full cursor-pointer">
                      ...
                      {isAdmin && (
                        <>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem asChild>
                            <Link href={siteConfig.paths.adminPanel} className="flex items-center w-full text-destructive cursor-pointer">
