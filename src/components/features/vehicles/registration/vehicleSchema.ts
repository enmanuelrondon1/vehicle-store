// src/components/features/vehicles/registration/vehicleSchema.ts
import { z } from 'zod';
import { 
  VehicleCategory, 
  TransmissionType, 
...
const step4Schema = z.object({
  ...
  location: z.string().min(5, "La ubicación es requerida (ej: Caracas, Distrito Capital)").max(200, "La ubicación no puede exceder 200 caracteres"),
});
