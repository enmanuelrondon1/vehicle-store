...
//src/componentes/features/vehicles/registration/BasicInfoStep.tsx
"use client";
...
const useFieldValidation = (value: FormFieldValue, fieldName: string, errors: FormErrors) => { // Mover fuera del componente
...
const InputField: React.FC<InputFieldProps> = ({ // Mover fuera del componente
  label,
  required,
  error,
  children,
...
const SelectField: React.FC<SelectFieldProps> = ({ // Mover fuera del componente
  value,
  onChange,
  onBlur,
  disabled,
